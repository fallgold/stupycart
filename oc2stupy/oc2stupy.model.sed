...
/\$this\->load\->model(['"]\([^\/]*\)\/\([^\/]*\)['"])/ {
# aaa/bbb => Aaa\Bbb
	s//$this->model_\1_\2 = new \\Stupycart\\Common\\Models\\\u\1\\\u\2()/g;
...
# dynamic model name
s/\$this\->load\->model(['"]\([^\/]*\)\/['"]\s*\.\s*\([^)]*\));/$_model_class_name = "\\\\Stupycart\\\\Common\\\\Models\\\\\u\1\\\\". ucfirst(\\Phalcon\\Text::camelize(\2));\n\t\t$this->{'model_\1_'. \2} = new $_model_class_name;/g;
