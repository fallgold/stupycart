...
class AuthorizeNetSimController extends \Stupycart\Frontend\Controllers\ControllerBase {
	public function indexAction() {
		 ...
		 * @var unknown_type
		 */
		$data['x_fp_sequence'] = $this->session->get('order_id');
		...
		$this->view->pick('payment/authorizenet_sim_index');
	...
	public function callbackAction() {
		...
		$this->view->pick('payment/authorizenet_sim_callback');
