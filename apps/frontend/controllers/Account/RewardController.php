...
class RewardController extends \Stupycart\Frontend\Controllers\ControllerBase {
	public function indexAction() {
		if (!$this->customer->isLogged()) {
			$this->session->set('redirect', $this->url->link('account/reward', '', 'SSL'));
		...
		$this->model_account_reward = new \Stupycart\Common\Models\Account\Reward();
