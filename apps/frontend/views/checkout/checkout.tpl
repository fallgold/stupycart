...
$(document).ready(function() {
	$.ajax({
		url: '{$this->url->getBaseUrl()}checkout/login',
		dataType: 'html',
...
$(document).ready(function() {
	$.ajax({
		url: '{$this->url->getBaseUrl()}checkout/payment_address',
		dataType: 'html',
		success: function(html) {
...
$('#button-account').live('click', function() {
	$.ajax({
		url: '{$this->url->getBaseUrl()}checkout/' + $('input[name=\'account\']:checked').attr('value'),
		dataType: 'html',
		beforeSend: function() {
			$('#button-account').attr('disabled', true);
			$('#button-account').after('<span class="wait">&nbsp;<img src="{$this->url->getBaseUrl()}theme/default/image/loading.gif" alt="" /></span>');
		},		
		complete: function() {
...
$('#button-login').live('click', function() {
	$.ajax({
		url: '{$this->url->getBaseUrl()}checkout/login/validate',
		type: 'post',
		data: $('#checkout #login :input'),
		dataType: 'json',
		beforeSend: function() {
			$('#button-login').attr('disabled', true);
			$('#button-login').after('<span class="wait">&nbsp;<img src="{$this->url->getBaseUrl()}theme/default/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
...
$('#button-register').live('click', function() {
	$.ajax({
		url: '{$this->url->getBaseUrl()}checkout/register/validate',
		type: 'post',
		data: $('#payment-address input[type=\'text\'], #payment-address input[type=\'password\'], #payment-address input[type=\'checkbox\']:checked, #payment-address input[type=\'radio\']:checked, #payment-address input[type=\'hidden\'], #payment-address select'),
		dataType: 'json',
		beforeSend: function() {
			$('#button-register').attr('disabled', true);
			$('#button-register').after('<span class="wait">&nbsp;<img src="{$this->url->getBaseUrl()}theme/default/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#payment-address .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="{$this->url->getBaseUrl()}theme/default/image/close.png" alt="" class="close" /></div>');
				...
				if (shipping_address) {
					$.ajax({
						url: '{$this->url->getBaseUrl()}checkout/shipping_method',
						dataType: 'html',
						success: function(html) {
							...
							$.ajax({
								url: '{$this->url->getBaseUrl()}checkout/shipping_address',
								dataType: 'html',
								success: function(html) {
				...
				<?php } else { ?>
				$.ajax({
					url: '{$this->url->getBaseUrl()}checkout/payment_method',
					dataType: 'html',
					success: function(html) {
...
$('#button-payment-address').live('click', function() {
	$.ajax({
		url: '{$this->url->getBaseUrl()}checkout/payment_address/validate',
		type: 'post',
		data: $('#payment-address input[type=\'text\'], #payment-address input[type=\'password\'], #payment-address input[type=\'checkbox\']:checked, #payment-address input[type=\'radio\']:checked, #payment-address input[type=\'hidden\'], #payment-address select'),
		dataType: 'json',
		beforeSend: function() {
			$('#button-payment-address').attr('disabled', true);
			$('#button-payment-address').after('<span class="wait">&nbsp;<img src="{$this->url->getBaseUrl()}theme/default/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
...
$('#button-shipping-address').live('click', function() {
	$.ajax({
		url: '{$this->url->getBaseUrl()}checkout/shipping_address/validate',
		type: 'post',
		...
		beforeSend: function() {
			...
			$('#button-shipping-address').after('<span class="wait">&nbsp;<img src="{$this->url->getBaseUrl()}theme/default/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#shipping-address .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="{$this->url->getBaseUrl()}theme/default/image/close.png" alt="" class="close" /></div>');
...
$('#button-guest').live('click', function() {
	$.ajax({
		url: '{$this->url->getBaseUrl()}checkout/guest/validate',
		type: 'post',
		data: $('#payment-address input[type=\'text\'], #payment-address input[type=\'checkbox\']:checked, #payment-address input[type=\'radio\']:checked, #payment-address input[type=\'hidden\'], #payment-address select'),
		dataType: 'json',
		beforeSend: function() {
			$('#button-guest').attr('disabled', true);
			$('#button-guest').after('<span class="wait">&nbsp;<img src="{$this->url->getBaseUrl()}theme/default/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
				...
				if (shipping_address) {
					$.ajax({
						...
						success: function(html) {
							...
							$.ajax({
								url: '{$this->url->getBaseUrl()}checkout/guest_shipping',
								dataType: 'html',
								success: function(html) {
									$('#shipping-address .checkout-content').html(html);
								},
...
$('#button-guest-shipping').live('click', function() {
	$.ajax({
		url: '{$this->url->getBaseUrl()}checkout/guest_shipping/validate',
		type: 'post',
		data: $('#shipping-address input[type=\'text\'], #shipping-address select'),
		dataType: 'json',
		beforeSend: function() {
			$('#button-guest-shipping').attr('disabled', true);
			$('#button-guest-shipping').after('<span class="wait">&nbsp;<img src="{$this->url->getBaseUrl()}theme/default/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
...
$('#button-shipping-method').live('click', function() {
	$.ajax({
		url: '{$this->url->getBaseUrl()}checkout/shipping_method/validate',
		type: 'post',
		data: $('#shipping-method input[type=\'radio\']:checked, #shipping-method textarea'),
		dataType: 'json',
		beforeSend: function() {
			$('#button-shipping-method').attr('disabled', true);
			$('#button-shipping-method').after('<span class="wait">&nbsp;<img src="{$this->url->getBaseUrl()}theme/default/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#shipping-method .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="{$this->url->getBaseUrl()}theme/default/image/close.png" alt="" class="close" /></div>');
...
$('#button-payment-method').live('click', function() {
	$.ajax({
		url: '{$this->url->getBaseUrl()}checkout/payment_method/validate', 
		type: 'post',
		data: $('#payment-method input[type=\'radio\']:checked, #payment-method input[type=\'checkbox\']:checked, #payment-method textarea'),
		dataType: 'json',
		beforeSend: function() {
			$('#button-payment-method').attr('disabled', true);
			$('#button-payment-method').after('<span class="wait">&nbsp;<img src="{$this->url->getBaseUrl()}theme/default/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#payment-method .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="{$this->url->getBaseUrl()}theme/default/image/close.png" alt="" class="close" /></div>');
					
					$('.warning').fadeIn('slow');
				}			
			} else {
				$.ajax({
					url: '{$this->url->getBaseUrl()}checkout/confirm',
					dataType: 'html',
					success: function(html) {
