...
$('#shipping-address select[name=\'country_id\']').bind('change', function() {
	...
	$.ajax({
		url: '{$this->url->getBaseUrl()}checkout/checkout/country?country_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
			$('#shipping-address select[name=\'country_id\']').after('<span class="wait">&nbsp;<img src="{$this->url->getBaseUrl()}theme/default/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
			$('.wait').remove();
		},			
