...
class SaleTaxController extends \Stupycart\Admin\Controllers\ControllerBase {
	public function indexAction() {     
		...
		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('report/sale_tax', 'token=' . $this->session->get('token') . $url, 'SSL'),
      		'separator' => ' :: '
   		);		
		...
		$pagination->url = $this->url->link('report/sale_tax', 'token=' . $this->session->get('token') . $url . '&page={page}', 'SSL');
		...
		$this->view->pick('report/sale_tax');
		$this->_commonAction();
