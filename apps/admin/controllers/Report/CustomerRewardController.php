...
class CustomerRewardController extends \Stupycart\Admin\Controllers\ControllerBase {
	public function indexAction() {     
		...
		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('report/customer_reward', 'token=' . $this->session->get('token') . $url, 'SSL'),
      		'separator' => ' :: '
   		);		
		...
		$pagination->url = $this->url->link('report/customer_reward', 'token=' . $this->session->get('token') . $url . '&page={page}', 'SSL');
		...
		$this->view->pick('report/customer_reward');
		$this->_commonAction();
