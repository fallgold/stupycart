...
namespace Stupycart\Admin\Controllers\Setting;

class SettingController extends \Stupycart\Admin\Controllers\ControllerBase {
	private $error = array();
	...
	public function indexAction() {
		...
		if (($this->request->getServer('REQUEST_METHOD') == 'POST') && $this->validate()) {
			$this->model_setting_setting->editSetting('config', $this->request->getPostE());
			...
			$this->response->redirect($this->url->link('setting/store', 'token=' . $this->session->get('token'), 'SSL'), true);
		return;
		}
		...
		if (isset($this->error['encryption'])) {
  		...
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('setting/setting', 'token=' . $this->session->get('token'), 'SSL'),
      		'separator' => ' :: '
   		);
		...
		$this->data['action'] = $this->url->link('setting/setting', 'token=' . $this->session->get('token'), 'SSL');
		
		$this->data['cancel'] = $this->url->link('setting/store', 'token=' . $this->session->get('token'), 'SSL');
		
		$this->data['token'] = $this->session->get('token');

		if ($this->request->hasPost('config_name')) {
			$this->data['config_name'] = $this->request->getPostE('config_name');
		} else {
			$this->data['config_name'] = $this->config->get('config_name');
		}
		
		if ($this->request->hasPost('config_owner')) {
			$this->data['config_owner'] = $this->request->getPostE('config_owner');
		} else {
			$this->data['config_owner'] = $this->config->get('config_owner');
		}

		if ($this->request->hasPost('config_address')) {
			$this->data['config_address'] = $this->request->getPostE('config_address');
		} else {
			$this->data['config_address'] = $this->config->get('config_address');
		}
		
		if ($this->request->hasPost('config_email')) {
			$this->data['config_email'] = $this->request->getPostE('config_email');
		} else {
			$this->data['config_email'] = $this->config->get('config_email');
		}
		
		if ($this->request->hasPost('config_telephone')) {
			$this->data['config_telephone'] = $this->request->getPostE('config_telephone');
		} else {
			$this->data['config_telephone'] = $this->config->get('config_telephone');
		}

		if ($this->request->hasPost('config_fax')) {
			$this->data['config_fax'] = $this->request->getPostE('config_fax');
		} else {
			$this->data['config_fax'] = $this->config->get('config_fax');
		}

		if ($this->request->hasPost('config_title')) {
			$this->data['config_title'] = $this->request->getPostE('config_title');
		} else {
			$this->data['config_title'] = $this->config->get('config_title');
		}
		
		if ($this->request->hasPost('config_meta_description')) {
			$this->data['config_meta_description'] = $this->request->getPostE('config_meta_description');
		} else {
			$this->data['config_meta_description'] = $this->config->get('config_meta_description');
		}
		
		if ($this->request->hasPost('config_layout_id')) {
			$this->data['config_layout_id'] = $this->request->getPostE('config_layout_id');
		} else {
		...
		if ($this->request->hasPost('config_template')) {
			$this->data['config_template'] = $this->request->getPostE('config_template');
		} else {
		...
		if ($this->request->hasPost('config_country_id')) {
			$this->data['config_country_id'] = $this->request->getPostE('config_country_id');
		} else {
		...
		if ($this->request->hasPost('config_zone_id')) {
			$this->data['config_zone_id'] = $this->request->getPostE('config_zone_id');
		} else {
			$this->data['config_zone_id'] = $this->config->get('config_zone_id');
		}		
		
		if ($this->request->hasPost('config_language')) {
			$this->data['config_language'] = $this->request->getPostE('config_language');
		} else {
		...
		if ($this->request->hasPost('config_admin_language')) {
			$this->data['config_admin_language'] = $this->request->getPostE('config_admin_language');
		} else {
			$this->data['config_admin_language'] = $this->config->get('config_admin_language');
		}

		if ($this->request->hasPost('config_currency')) {
			$this->data['config_currency'] = $this->request->getPostE('config_currency');
		} else {
			$this->data['config_currency'] = $this->config->get('config_currency');
		}

		if ($this->request->hasPost('config_currency_auto')) {
			$this->data['config_currency_auto'] = $this->request->getPostE('config_currency_auto');
		} else {
		...
		if ($this->request->hasPost('config_length_class_id')) {
			$this->data['config_length_class_id'] = $this->request->getPostE('config_length_class_id');
		} else {
		...
		if ($this->request->hasPost('config_weight_class_id')) {
			$this->data['config_weight_class_id'] = $this->request->getPostE('config_weight_class_id');
		} else {
		...
		if ($this->request->hasPost('config_catalog_limit')) {
			$this->data['config_catalog_limit'] = $this->request->getPostE('config_catalog_limit');
		} else {
			$this->data['config_catalog_limit'] = $this->config->get('config_catalog_limit');
		}	
						
		if ($this->request->hasPost('config_admin_limit')) {
			$this->data['config_admin_limit'] = $this->request->getPostE('config_admin_limit');
		} else {
			$this->data['config_admin_limit'] = $this->config->get('config_admin_limit');
		}
		
		if ($this->request->hasPost('config_product_count')) {
			$this->data['config_product_count'] = $this->request->getPostE('config_product_count');
		} else {
			$this->data['config_product_count'] = $this->config->get('config_product_count');
		}
				
		if ($this->request->hasPost('config_review_status')) {
			$this->data['config_review_status'] = $this->request->getPostE('config_review_status');
		} else {
			$this->data['config_review_status'] = $this->config->get('config_review_status');
		}
		
		if ($this->request->hasPost('config_download')) {
			$this->data['config_download'] = $this->request->getPostE('config_download');
		} else {
			$this->data['config_download'] = $this->config->get('config_download');
		}
		
		if ($this->request->hasPost('config_voucher_min')) {
			$this->data['config_voucher_min'] = $this->request->getPostE('config_voucher_min');
		} else {
			$this->data['config_voucher_min'] = $this->config->get('config_voucher_min');
		}	
		
		if ($this->request->hasPost('config_voucher_max')) {
			$this->data['config_voucher_max'] = $this->request->getPostE('config_voucher_max');
		} else {
			$this->data['config_voucher_max'] = $this->config->get('config_voucher_max');
		}				
		
		if ($this->request->hasPost('config_tax')) {
			$this->data['config_tax'] = $this->request->getPostE('config_tax');
		} else {
			$this->data['config_tax'] = $this->config->get('config_tax');			
		}
		
		if ($this->request->hasPost('config_vat')) {
			$this->data['config_vat'] = $this->request->getPostE('config_vat');
		} else {
			$this->data['config_vat'] = $this->config->get('config_vat');			
		}
				
		if ($this->request->hasPost('config_tax_default')) {
			$this->data['config_tax_default'] = $this->request->getPostE('config_tax_default');
		} else {
			$this->data['config_tax_default'] = $this->config->get('config_tax_default');			
		}	
			
		if ($this->request->hasPost('config_tax_customer')) {
			$this->data['config_tax_customer'] = $this->request->getPostE('config_tax_customer');
		} else {
			$this->data['config_tax_customer'] = $this->config->get('config_tax_customer');			
		}	
		
		if ($this->request->hasPost('config_customer_online')) {
			$this->data['config_customer_online'] = $this->request->getPostE('config_customer_online');
		} else {
			$this->data['config_customer_online'] = $this->config->get('config_customer_online');			
		}
						
		if ($this->request->hasPost('config_customer_group_id')) {
			$this->data['config_customer_group_id'] = $this->request->getPostE('config_customer_group_id');
		} else {
		...
		if ($this->request->hasPost('config_customer_group_display')) {
			$this->data['config_customer_group_display'] = $this->request->getPostE('config_customer_group_display');
		...
		if ($this->request->hasPost('config_customer_price')) {
			$this->data['config_customer_price'] = $this->request->getPostE('config_customer_price');
		} else {
			$this->data['config_customer_price'] = $this->config->get('config_customer_price');			
		}
						
		if ($this->request->hasPost('config_account_id')) {
			$this->data['config_account_id'] = $this->request->getPostE('config_account_id');
		} else {
		...
		if ($this->request->hasPost('config_cart_weight')) {
			$this->data['config_cart_weight'] = $this->request->getPostE('config_cart_weight');
		} else {
			$this->data['config_cart_weight'] = $this->config->get('config_cart_weight');
		}							
						
		if ($this->request->hasPost('config_guest_checkout')) {
			$this->data['config_guest_checkout'] = $this->request->getPostE('config_guest_checkout');
		} else {
			$this->data['config_guest_checkout'] = $this->config->get('config_guest_checkout');		
		}

		if ($this->request->hasPost('config_checkout_id')) {
			$this->data['config_checkout_id'] = $this->request->getPostE('config_checkout_id');
		} else {
			$this->data['config_checkout_id'] = $this->config->get('config_checkout_id');		
		}

		if ($this->request->hasPost('config_order_edit')) {
			$this->data['config_order_edit'] = $this->request->getPostE('config_order_edit');
		...
		if ($this->request->hasPost('config_invoice_prefix')) {
			$this->data['config_invoice_prefix'] = $this->request->getPostE('config_invoice_prefix');
		...
		if ($this->request->hasPost('config_order_status_id')) {
			$this->data['config_order_status_id'] = $this->request->getPostE('config_order_status_id');
		} else {
			$this->data['config_order_status_id'] = $this->config->get('config_order_status_id');		
		}
		
		if ($this->request->hasPost('config_complete_status_id')) {
			$this->data['config_complete_status_id'] = $this->request->getPostE('config_complete_status_id');
		} else {
		...
		if ($this->request->hasPost('config_stock_display')) {
			$this->data['config_stock_display'] = $this->request->getPostE('config_stock_display');
		} else {
			$this->data['config_stock_display'] = $this->config->get('config_stock_display');			
		}
		
		if ($this->request->hasPost('config_stock_warning')) {
			$this->data['config_stock_warning'] = $this->request->getPostE('config_stock_warning');
		} else {
			$this->data['config_stock_warning'] = $this->config->get('config_stock_warning');		
		}

		if ($this->request->hasPost('config_stock_checkout')) {
			$this->data['config_stock_checkout'] = $this->request->getPostE('config_stock_checkout');
		} else {
			$this->data['config_stock_checkout'] = $this->config->get('config_stock_checkout');		
		}

		if ($this->request->hasPost('config_stock_status_id')) {
			$this->data['config_stock_status_id'] = $this->request->getPostE('config_stock_status_id');
		} else {
		...
		if ($this->request->hasPost('config_affiliate_id')) {
			$this->data['config_affiliate_id'] = $this->request->getPostE('config_affiliate_id');
		} else {
			$this->data['config_affiliate_id'] = $this->config->get('config_affiliate_id');		
		}
		
		if ($this->request->hasPost('config_commission')) {
			$this->data['config_commission'] = $this->request->getPostE('config_commission');
		...
		if ($this->request->hasPost('config_return_id')) {
			$this->data['config_return_id'] = $this->request->getPostE('config_return_id');
		} else {
			$this->data['config_return_id'] = $this->config->get('config_return_id');		
		}
						
		if ($this->request->hasPost('config_return_status_id')) {
			$this->data['config_return_status_id'] = $this->request->getPostE('config_return_status_id');
		} else {
		...
		if ($this->request->hasPost('config_logo')) {
			$this->data['config_logo'] = $this->request->getPostE('config_logo');
		} else {
		...
		if ($this->request->hasPost('config_icon')) {
			$this->data['config_icon'] = $this->request->getPostE('config_icon');
		} else {
		...
		if ($this->request->hasPost('config_image_category_width')) {
			$this->data['config_image_category_width'] = $this->request->getPostE('config_image_category_width');
		} else {
			$this->data['config_image_category_width'] = $this->config->get('config_image_category_width');
		}
		
		if ($this->request->hasPost('config_image_category_height')) {
			$this->data['config_image_category_height'] = $this->request->getPostE('config_image_category_height');
		} else {
			$this->data['config_image_category_height'] = $this->config->get('config_image_category_height');
		}
				
		if ($this->request->hasPost('config_image_thumb_width')) {
			$this->data['config_image_thumb_width'] = $this->request->getPostE('config_image_thumb_width');
		} else {
			$this->data['config_image_thumb_width'] = $this->config->get('config_image_thumb_width');
		}
		
		if ($this->request->hasPost('config_image_thumb_height')) {
			$this->data['config_image_thumb_height'] = $this->request->getPostE('config_image_thumb_height');
		} else {
			$this->data['config_image_thumb_height'] = $this->config->get('config_image_thumb_height');
		}
		
		if ($this->request->hasPost('config_image_popup_width')) {
			$this->data['config_image_popup_width'] = $this->request->getPostE('config_image_popup_width');
		} else {
			$this->data['config_image_popup_width'] = $this->config->get('config_image_popup_width');
		}
		
		if ($this->request->hasPost('config_image_popup_height')) {
			$this->data['config_image_popup_height'] = $this->request->getPostE('config_image_popup_height');
		} else {
			$this->data['config_image_popup_height'] = $this->config->get('config_image_popup_height');
		}
		
		if ($this->request->hasPost('config_image_product_width')) {
			$this->data['config_image_product_width'] = $this->request->getPostE('config_image_product_width');
		} else {
			$this->data['config_image_product_width'] = $this->config->get('config_image_product_width');
		}
		
		if ($this->request->hasPost('config_image_product_height')) {
			$this->data['config_image_product_height'] = $this->request->getPostE('config_image_product_height');
		} else {
			$this->data['config_image_product_height'] = $this->config->get('config_image_product_height');
		}

		if ($this->request->hasPost('config_image_additional_width')) {
			$this->data['config_image_additional_width'] = $this->request->getPostE('config_image_additional_width');
		} else {
			$this->data['config_image_additional_width'] = $this->config->get('config_image_additional_width');
		}
		
		if ($this->request->hasPost('config_image_additional_height')) {
			$this->data['config_image_additional_height'] = $this->request->getPostE('config_image_additional_height');
		} else {
			$this->data['config_image_additional_height'] = $this->config->get('config_image_additional_height');
		}
		
		if ($this->request->hasPost('config_image_related_width')) {
			$this->data['config_image_related_width'] = $this->request->getPostE('config_image_related_width');
		} else {
			$this->data['config_image_related_width'] = $this->config->get('config_image_related_width');
		}
		
		if ($this->request->hasPost('config_image_related_height')) {
			$this->data['config_image_related_height'] = $this->request->getPostE('config_image_related_height');
		} else {
			$this->data['config_image_related_height'] = $this->config->get('config_image_related_height');
		}
		
		if ($this->request->hasPost('config_image_compare_width')) {
			$this->data['config_image_compare_width'] = $this->request->getPostE('config_image_compare_width');
		} else {
			$this->data['config_image_compare_width'] = $this->config->get('config_image_compare_width');
		}
		
		if ($this->request->hasPost('config_image_compare_height')) {
			$this->data['config_image_compare_height'] = $this->request->getPostE('config_image_compare_height');
		} else {
			$this->data['config_image_compare_height'] = $this->config->get('config_image_compare_height');
		}	
		
		if ($this->request->hasPost('config_image_wishlist_width')) {
			$this->data['config_image_wishlist_width'] = $this->request->getPostE('config_image_wishlist_width');
		} else {
			$this->data['config_image_wishlist_width'] = $this->config->get('config_image_wishlist_width');
		}
		
		if ($this->request->hasPost('config_image_wishlist_height')) {
			$this->data['config_image_wishlist_height'] = $this->request->getPostE('config_image_wishlist_height');
		} else {
			$this->data['config_image_wishlist_height'] = $this->config->get('config_image_wishlist_height');
		}	
						
		if ($this->request->hasPost('config_image_cart_width')) {
			$this->data['config_image_cart_width'] = $this->request->getPostE('config_image_cart_width');
		} else {
			$this->data['config_image_cart_width'] = $this->config->get('config_image_cart_width');
		}
		
		if ($this->request->hasPost('config_image_cart_height')) {
			$this->data['config_image_cart_height'] = $this->request->getPostE('config_image_cart_height');
		} else {
			$this->data['config_image_cart_height'] = $this->config->get('config_image_cart_height');
		}		
				
		if ($this->request->hasPost('config_ftp_host')) {
			$this->data['config_ftp_host'] = $this->request->getPostE('config_ftp_host');
		} elseif ($this->config->get('config_ftp_host')) {
			$this->data['config_ftp_host'] = $this->config->get('config_ftp_host');		
		} else {
			$this->data['config_ftp_host'] = str_replace('www.', '', $this->request->getServer('HTTP_HOST'));
		}
		
		if ($this->request->hasPost('config_ftp_port')) {
			$this->data['config_ftp_port'] = $this->request->getPostE('config_ftp_port');
		...
		if ($this->request->hasPost('config_ftp_username')) {
			$this->data['config_ftp_username'] = $this->request->getPostE('config_ftp_username');
		} else {
			$this->data['config_ftp_username'] = $this->config->get('config_ftp_username');
		}
		
		if ($this->request->hasPost('config_ftp_password')) {
			$this->data['config_ftp_password'] = $this->request->getPostE('config_ftp_password');
		} else {
			$this->data['config_ftp_password'] = $this->config->get('config_ftp_password');
		}
		
		if ($this->request->hasPost('config_ftp_root')) {
			$this->data['config_ftp_root'] = $this->request->getPostE('config_ftp_root');
		} else {
			$this->data['config_ftp_root'] = $this->config->get('config_ftp_root');
		}
		
		if ($this->request->hasPost('config_ftp_status')) {
			$this->data['config_ftp_status'] = $this->request->getPostE('config_ftp_status');
		} else {
			$this->data['config_ftp_status'] = $this->config->get('config_ftp_status');
		}
												
		if ($this->request->hasPost('config_mail_protocol')) {
			$this->data['config_mail_protocol'] = $this->request->getPostE('config_mail_protocol');
		} else {
			$this->data['config_mail_protocol'] = $this->config->get('config_mail_protocol');
		}
		
		if ($this->request->hasPost('config_mail_parameter')) {
			$this->data['config_mail_parameter'] = $this->request->getPostE('config_mail_parameter');
		} else {
			$this->data['config_mail_parameter'] = $this->config->get('config_mail_parameter');
		}
				
		if ($this->request->hasPost('config_smtp_host')) {
			$this->data['config_smtp_host'] = $this->request->getPostE('config_smtp_host');
		} else {
			$this->data['config_smtp_host'] = $this->config->get('config_smtp_host');
		}		

		if ($this->request->hasPost('config_smtp_username')) {
			$this->data['config_smtp_username'] = $this->request->getPostE('config_smtp_username');
		} else {
			$this->data['config_smtp_username'] = $this->config->get('config_smtp_username');
		}	
		
		if ($this->request->hasPost('config_smtp_password')) {
			$this->data['config_smtp_password'] = $this->request->getPostE('config_smtp_password');
		} else {
			$this->data['config_smtp_password'] = $this->config->get('config_smtp_password');
		}	
		
		if ($this->request->hasPost('config_smtp_port')) {
			$this->data['config_smtp_port'] = $this->request->getPostE('config_smtp_port');
		...
		if ($this->request->hasPost('config_smtp_timeout')) {
			$this->data['config_smtp_timeout'] = $this->request->getPostE('config_smtp_timeout');
		...
		if ($this->request->hasPost('config_alert_mail')) {
			$this->data['config_alert_mail'] = $this->request->getPostE('config_alert_mail');
		} else {
			$this->data['config_alert_mail'] = $this->config->get('config_alert_mail');
		}

		if ($this->request->hasPost('config_account_mail')) {
			$this->data['config_account_mail'] = $this->request->getPostE('config_account_mail');
		} else {
			$this->data['config_account_mail'] = $this->config->get('config_account_mail');
		}
		
		if ($this->request->hasPost('config_alert_emails')) {
			$this->data['config_alert_emails'] = $this->request->getPostE('config_alert_emails');
		} else {
			$this->data['config_alert_emails'] = $this->config->get('config_alert_emails');
		}
		
		if ($this->request->hasPost('config_fraud_detection')) {
			$this->data['config_fraud_detection'] = $this->request->getPostE('config_fraud_detection'); 
		} else {
			$this->data['config_fraud_detection'] = $this->config->get('config_fraud_detection');
		}	
				
		if ($this->request->hasPost('config_fraud_key')) {
			$this->data['config_fraud_key'] = $this->request->getPostE('config_fraud_key'); 
		} else {
			$this->data['config_fraud_key'] = $this->config->get('config_fraud_key');
		}		

		if ($this->request->hasPost('config_fraud_score')) {
			$this->data['config_fraud_score'] = $this->request->getPostE('config_fraud_score'); 
		} else {
			$this->data['config_fraud_score'] = $this->config->get('config_fraud_score');
		}	
			
		if ($this->request->hasPost('config_fraud_status_id')) {
			$this->data['config_fraud_status_id'] = $this->request->getPostE('config_fraud_status_id'); 
		} else {
			$this->data['config_fraud_status_id'] = $this->config->get('config_fraud_status_id');
		}		
				
		if ($this->request->hasPost('config_secure')) {
			$this->data['config_secure'] = $this->request->getPostE('config_secure');
		} else {
			$this->data['config_secure'] = $this->config->get('config_secure');
		}

		if ($this->request->hasPost('config_shared')) {
			$this->data['config_shared'] = $this->request->getPostE('config_shared');
		} else {
			$this->data['config_shared'] = $this->config->get('config_shared');
		}
		
		if ($this->request->hasPost('config_robots')) {
			$this->data['config_robots'] = $this->request->getPostE('config_robots');
		} else {
			$this->data['config_robots'] = $this->config->get('config_robots');
		}
						
		if ($this->request->hasPost('config_seo_url')) {
			$this->data['config_seo_url'] = $this->request->getPostE('config_seo_url');
		} else {
			$this->data['config_seo_url'] = $this->config->get('config_seo_url');
		}
		
		if ($this->request->hasPost('config_file_extension_allowed')) {
			$this->data['config_file_extension_allowed'] = $this->request->getPostE('config_file_extension_allowed');
		} else {
			$this->data['config_file_extension_allowed'] = $this->config->get('config_file_extension_allowed');
		}
		
		if ($this->request->hasPost('config_file_mime_allowed')) {
			$this->data['config_file_mime_allowed'] = $this->request->getPostE('config_file_mime_allowed');
		} else {
			$this->data['config_file_mime_allowed'] = $this->config->get('config_file_mime_allowed');
		}		
				
		if ($this->request->hasPost('config_maintenance')) {
			$this->data['config_maintenance'] = $this->request->getPostE('config_maintenance');
		} else {
			$this->data['config_maintenance'] = $this->config->get('config_maintenance');
		}
		
		if ($this->request->hasPost('config_password')) {
			$this->data['config_password'] = $this->request->getPostE('config_password');
		} else {
			$this->data['config_password'] = $this->config->get('config_password');
		}
				
		if ($this->request->hasPost('config_encryption')) {
			$this->data['config_encryption'] = $this->request->getPostE('config_encryption');
		} else {
			$this->data['config_encryption'] = $this->config->get('config_encryption');
		}
		
		if ($this->request->hasPost('config_compression')) {
			$this->data['config_compression'] = $this->request->getPostE('config_compression'); 
		} else {
			$this->data['config_compression'] = $this->config->get('config_compression');
		}

		if ($this->request->hasPost('config_error_display')) {
			$this->data['config_error_display'] = $this->request->getPostE('config_error_display'); 
		} else {
			$this->data['config_error_display'] = $this->config->get('config_error_display');
		}

		if ($this->request->hasPost('config_error_log')) {
			$this->data['config_error_log'] = $this->request->getPostE('config_error_log'); 
		} else {
			$this->data['config_error_log'] = $this->config->get('config_error_log');
		}

		if ($this->request->hasPost('config_error_filename')) {
			$this->data['config_error_filename'] = $this->request->getPostE('config_error_filename'); 
		} else {
			$this->data['config_error_filename'] = $this->config->get('config_error_filename');
		}
				
		if ($this->request->hasPost('config_google_analytics')) {
			$this->data['config_google_analytics'] = $this->request->getPostE('config_google_analytics'); 
		} else {
	...
	protected function validate() {
		...
		if (!$this->request->getPostE('config_name')) {
			$this->error['name'] = $this->language->get('error_name');
		}	
		
		if ((utf8_strlen($this->request->getPostE('config_owner')) < 3) || (utf8_strlen($this->request->getPostE('config_owner')) > 64)) {
			$this->error['owner'] = $this->language->get('error_owner');
		}

		if ((utf8_strlen($this->request->getPostE('config_address')) < 3) || (utf8_strlen($this->request->getPostE('config_address')) > 256)) {
			$this->error['address'] = $this->language->get('error_address');
		}
		
    	if ((utf8_strlen($this->request->getPostE('config_email')) > 96) || !preg_match('/^[^\@]+@.*\.[a-z]{2,6}$/i', $this->request->getPostE('config_email'))) {
      		$this->error['email'] = $this->language->get('error_email');
    	}

    	if ((utf8_strlen($this->request->getPostE('config_telephone')) < 3) || (utf8_strlen($this->request->getPostE('config_telephone')) > 32)) {
      		$this->error['telephone'] = $this->language->get('error_telephone');
    	}

		if (!$this->request->getPostE('config_title')) {
			$this->error['title'] = $this->language->get('error_title');
		}	
		
		if (!(!$this->request->getPostE('config_customer_group_display')) && !in_array($this->request->getPostE('config_customer_group_id'), $this->request->getPostE('config_customer_group_display'))) {
			$this->error['customer_group_display'] = $this->language->get('error_customer_group_display');
		}	
		
		if (!$this->request->getPostE('config_voucher_min')) {
			$this->error['voucher_min'] = $this->language->get('error_voucher_min');
		}	
		
		if (!$this->request->getPostE('config_voucher_max')) {
			$this->error['voucher_max'] = $this->language->get('error_voucher_max');
		}	
								
		if (!$this->request->getPostE('config_image_category_width') || !$this->request->getPostE('config_image_category_height')) {
			$this->error['image_category'] = $this->language->get('error_image_category');
		} 
				
		if (!$this->request->getPostE('config_image_thumb_width') || !$this->request->getPostE('config_image_thumb_height')) {
			$this->error['image_thumb'] = $this->language->get('error_image_thumb');
		}	
		
		if (!$this->request->getPostE('config_image_popup_width') || !$this->request->getPostE('config_image_popup_height')) {
			$this->error['image_popup'] = $this->language->get('error_image_popup');
		}	
		
		if (!$this->request->getPostE('config_image_product_width') || !$this->request->getPostE('config_image_product_height')) {
			$this->error['image_product'] = $this->language->get('error_image_product');
		}
				
		if (!$this->request->getPostE('config_image_additional_width') || !$this->request->getPostE('config_image_additional_height')) {
			$this->error['image_additional'] = $this->language->get('error_image_additional');
		}
		
		if (!$this->request->getPostE('config_image_related_width') || !$this->request->getPostE('config_image_related_height')) {
			$this->error['image_related'] = $this->language->get('error_image_related');
		}
		
		if (!$this->request->getPostE('config_image_compare_width') || !$this->request->getPostE('config_image_compare_height')) {
			$this->error['image_compare'] = $this->language->get('error_image_compare');
		}
		
		if (!$this->request->getPostE('config_image_wishlist_width') || !$this->request->getPostE('config_image_wishlist_height')) {
			$this->error['image_wishlist'] = $this->language->get('error_image_wishlist');
		}			
		
		if (!$this->request->getPostE('config_image_cart_width') || !$this->request->getPostE('config_image_cart_height')) {
			$this->error['image_cart'] = $this->language->get('error_image_cart');
		}
		
		if ($this->request->getPostE('config_ftp_status')) {
			if (!$this->request->getPostE('config_ftp_host')) {
				$this->error['ftp_host'] = $this->language->get('error_ftp_host');
			}
			
			if (!$this->request->getPostE('config_ftp_port')) {
				$this->error['ftp_port'] = $this->language->get('error_ftp_port');
			}
			
			if (!$this->request->getPostE('config_ftp_username')) {
				$this->error['ftp_username'] = $this->language->get('error_ftp_username');
			}	
			
			if (!$this->request->getPostE('config_ftp_password')) {
				$this->error['ftp_password'] = $this->language->get('error_ftp_password');
			}											
		}
	
		if (!$this->request->getPostE('config_error_filename')) {
			$this->error['error_filename'] = $this->language->get('error_error_filename');
		}
		
		if (!$this->request->getPostE('config_catalog_limit')) {
			$this->error['catalog_limit'] = $this->language->get('error_limit');
		}
		
		if (!$this->request->getPostE('config_admin_limit')) {
			$this->error['admin_limit'] = $this->language->get('error_limit');
		}
				
		if ((utf8_strlen($this->request->getPostE('config_encryption')) < 3) || (utf8_strlen($this->request->getPostE('config_encryption')) > 32)) {
	...
	public function templateAction() {
		...
		if (file_exists(DIR_IMAGE . 'templates/' . basename($this->request->getQueryE('template')) . '.png')) {
			$image = $server . 'image/templates/' . basename($this->request->getQueryE('template')) . '.png';
		} else {
			$image = $server . 'image/no_image.jpg';
		}
		
		$this->response->setContent('<img src="' . $image . '" alt="" title="" style="border: 1px solid #EEEEEE;" />');
