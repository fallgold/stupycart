...
class UPSController extends \Stupycart\Admin\Controllers\ControllerBase {
	private $error = array(); 
	...
	public function indexAction() {
		...
		if (($this->request->getServer('REQUEST_METHOD') == 'POST') && $this->validate()) {
			$this->model_setting_setting->editSetting('ups', $this->request->getPostE());		
		...
		if (isset($this->error['dimension'])) {
  		...
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('shipping/ups', 'token=' . $this->session->get('token'), 'SSL'),
      		'separator' => ' :: '
   		);
		
		$this->data['action'] = $this->url->link('shipping/ups', 'token=' . $this->session->get('token'), 'SSL');
		
		$this->data['cancel'] = $this->url->link('extension/shipping', 'token=' . $this->session->get('token'), 'SSL');
		
		if ($this->request->hasPost('ups_key')) {
			$this->data['ups_key'] = $this->request->getPostE('ups_key');
		} else {
			$this->data['ups_key'] = $this->config->get('ups_key');
		}

		if ($this->request->hasPost('ups_username')) {
			$this->data['ups_username'] = $this->request->getPostE('ups_username');
		} else {
			$this->data['ups_username'] = $this->config->get('ups_username');
		}
		
		if ($this->request->hasPost('ups_password')) {
			$this->data['ups_password'] = $this->request->getPostE('ups_password');
		} else {
			$this->data['ups_password'] = $this->config->get('ups_password');
		}
		
		if ($this->request->hasPost('ups_pickup')) {
			$this->data['ups_pickup'] = $this->request->getPostE('ups_pickup');
		} else {
		...
		if ($this->request->hasPost('ups_packaging')) {
			$this->data['ups_packaging'] = $this->request->getPostE('ups_packaging');
		} else {
		...
		if ($this->request->hasPost('ups_classification')) {
			$this->data['ups_classification'] = $this->request->getPostE('ups_classification');
		} else {
		...
		if ($this->request->hasPost('ups_origin')) {
			$this->data['ups_origin'] = $this->request->getPostE('ups_origin');
		} else {
		...
		if ($this->request->hasPost('ups_city')) {
			$this->data['ups_city'] = $this->request->getPostE('ups_city');
		} else {
			$this->data['ups_city'] = $this->config->get('ups_city');
		}

		if ($this->request->hasPost('ups_state')) {
			$this->data['ups_state'] = $this->request->getPostE('ups_state');
		} else {
			$this->data['ups_state'] = $this->config->get('ups_state');
		}

		if ($this->request->hasPost('ups_country')) {
			$this->data['ups_country'] = $this->request->getPostE('ups_country');
		} else {
			$this->data['ups_country'] = $this->config->get('ups_country');
		}

		if ($this->request->hasPost('ups_postcode')) {
			$this->data['ups_postcode'] = $this->request->getPostE('ups_postcode');
		} else {
			$this->data['ups_postcode'] = $this->config->get('ups_postcode');
		}
		
		if ($this->request->hasPost('ups_test')) {
			$this->data['ups_test'] = $this->request->getPostE('ups_test');
		} else {
			$this->data['ups_test'] = $this->config->get('ups_test');
		}		

		if ($this->request->hasPost('ups_quote_type')) {
			$this->data['ups_quote_type'] = $this->request->getPostE('ups_quote_type');
		} else {
		...
		// US
		if ($this->request->hasPost('ups_us_01')) {
			$this->data['ups_us_01'] = $this->request->getPostE('ups_us_01');
		} else {
			$this->data['ups_us_01'] = $this->config->get('ups_us_01');
		}				
		
		if ($this->request->hasPost('ups_us_02')) {
			$this->data['ups_us_02'] = $this->request->getPostE('ups_us_02');
		} else {
			$this->data['ups_us_02'] = $this->config->get('ups_us_02');
		}			

		if ($this->request->hasPost('ups_us_03')) {
			$this->data['ups_us_03'] = $this->request->getPostE('ups_us_03');
		} else {
			$this->data['ups_us_03'] = $this->config->get('ups_us_03');
		}	

		if ($this->request->hasPost('ups_us_07')) {
			$this->data['ups_us_07'] = $this->request->getPostE('ups_us_07');
		} else {
			$this->data['ups_us_07'] = $this->config->get('ups_us_07');
		}	
		
		if ($this->request->hasPost('ups_us_08')) {
			$this->data['ups_us_08'] = $this->request->getPostE('ups_us_08');
		} else {
			$this->data['ups_us_08'] = $this->config->get('ups_us_08');
		}	
		
		if ($this->request->hasPost('ups_us_11')) {
			$this->data['ups_us_11'] = $this->request->getPostE('ups_us_11');
		} else {
			$this->data['ups_us_11'] = $this->config->get('ups_us_11');
		}	
		
		if ($this->request->hasPost('ups_us_12')) {
			$this->data['ups_us_12'] = $this->request->getPostE('ups_us_12');
		} else {
			$this->data['ups_us_12'] = $this->config->get('ups_us_12');
		}	

		if ($this->request->hasPost('ups_us_13')) {
			$this->data['ups_us_13'] = $this->request->getPostE('ups_us_13');
		} else {
			$this->data['ups_us_13'] = $this->config->get('ups_us_13');
		}	

		if ($this->request->hasPost('ups_us_14')) {
			$this->data['ups_us_14'] = $this->request->getPostE('ups_us_14');
		} else {
			$this->data['ups_us_14'] = $this->config->get('ups_us_14');
		}	
		
		if ($this->request->hasPost('ups_us_54')) {
			$this->data['ups_us_54'] = $this->request->getPostE('ups_us_54');
		} else {
			$this->data['ups_us_54'] = $this->config->get('ups_us_54');
		}
		
		if ($this->request->hasPost('ups_us_59')) {
			$this->data['ups_us_59'] = $this->request->getPostE('ups_us_59');
		} else {
			$this->data['ups_us_59'] = $this->config->get('ups_us_59');
		}	
		
		if ($this->request->hasPost('ups_us_65')) {
			$this->data['ups_us_65'] = $this->request->getPostE('ups_us_65');
		} else {
			$this->data['ups_us_65'] = $this->config->get('ups_us_65');
		}	
		
		// Puerto Rico
		if ($this->request->hasPost('ups_pr_01')) {
			$this->data['ups_pr_01'] = $this->request->getPostE('ups_pr_01');
		} else {
			$this->data['ups_pr_01'] = $this->config->get('ups_pr_01');
		}	

		if ($this->request->hasPost('ups_pr_02')) {
			$this->data['ups_pr_02'] = $this->request->getPostE('ups_pr_02');
		} else {
			$this->data['ups_pr_02'] = $this->config->get('ups_pr_02');
		}	
		
		if ($this->request->hasPost('ups_pr_03')) {
			$this->data['ups_pr_03'] = $this->request->getPostE('ups_pr_03');
		} else {
			$this->data['ups_pr_03'] = $this->config->get('ups_pr_03');
		}
		
		if ($this->request->hasPost('ups_pr_07')) {
			$this->data['ups_pr_07'] = $this->request->getPostE('ups_pr_07');
		} else {
			$this->data['ups_pr_07'] = $this->config->get('ups_pr_07');
		}
		
		if ($this->request->hasPost('ups_pr_08')) {
			$this->data['ups_pr_08'] = $this->request->getPostE('ups_pr_08');
		} else {
			$this->data['ups_pr_08'] = $this->config->get('ups_pr_08');
		}
		
		if ($this->request->hasPost('ups_pr_14')) {
			$this->data['ups_pr_14'] = $this->request->getPostE('ups_pr_14');
		} else {
			$this->data['ups_pr_14'] = $this->config->get('ups_pr_14');
		}
		
		if ($this->request->hasPost('ups_pr_54')) {
			$this->data['ups_pr_54'] = $this->request->getPostE('ups_pr_54');
		} else {
			$this->data['ups_pr_54'] = $this->config->get('ups_pr_54');
		}
		
		if ($this->request->hasPost('ups_pr_65')) {
			$this->data['ups_pr_65'] = $this->request->getPostE('ups_pr_65');
		} else {
			$this->data['ups_pr_65'] = $this->config->get('ups_pr_65');
		}

		// Canada
		if ($this->request->hasPost('ups_ca_01')) {
			$this->data['ups_ca_01'] = $this->request->getPostE('ups_ca_01');
		} else {
			$this->data['ups_ca_01'] = $this->config->get('ups_ca_01');
		}
		
		if ($this->request->hasPost('ups_ca_02')) {
			$this->data['ups_ca_02'] = $this->request->getPostE('ups_ca_02');
		} else {
			$this->data['ups_ca_02'] = $this->config->get('ups_ca_02');
		}
		
		if ($this->request->hasPost('ups_ca_07')) {
			$this->data['ups_ca_07'] = $this->request->getPostE('ups_ca_07');
		} else {
			$this->data['ups_ca_07'] = $this->config->get('ups_ca_07');
		}
		
		if ($this->request->hasPost('ups_ca_08')) {
			$this->data['ups_ca_08'] = $this->request->getPostE('ups_ca_08');
		} else {
			$this->data['ups_ca_08'] = $this->config->get('ups_ca_08');
		}
		
		if ($this->request->hasPost('ups_ca_11')) {
			$this->data['ups_ca_11'] = $this->request->getPostE('ups_ca_11');
		} else {
			$this->data['ups_ca_11'] = $this->config->get('ups_ca_11');
		}
		
		if ($this->request->hasPost('ups_ca_12')) {
			$this->data['ups_ca_12'] = $this->request->getPostE('ups_ca_12');
		} else {
			$this->data['ups_ca_12'] = $this->config->get('ups_ca_12');
		}
		
		if ($this->request->hasPost('ups_ca_13')) {
			$this->data['ups_ca_13'] = $this->request->getPostE('ups_ca_13');
		} else {
			$this->data['ups_ca_13'] = $this->config->get('ups_ca_13');
		}
		
		if ($this->request->hasPost('ups_ca_14')) {
			$this->data['ups_ca_14'] = $this->request->getPostE('ups_ca_14');
		} else {
			$this->data['ups_ca_14'] = $this->config->get('ups_ca_14');
		}
		
		if ($this->request->hasPost('ups_ca_54')) {
			$this->data['ups_ca_54'] = $this->request->getPostE('ups_ca_54');
		} else {
			$this->data['ups_ca_54'] = $this->config->get('ups_ca_54');
		}
		
		if ($this->request->hasPost('ups_ca_65')) {
			$this->data['ups_ca_65'] = $this->request->getPostE('ups_ca_65');
		} else {
			$this->data['ups_ca_65'] = $this->config->get('ups_ca_65');
		}

		// Mexico
		if ($this->request->hasPost('ups_mx_07')) {
			$this->data['ups_mx_07'] = $this->request->getPostE('ups_mx_07');
		} else {
			$this->data['ups_mx_07'] = $this->config->get('ups_mx_07');
		}
		
		if ($this->request->hasPost('ups_mx_08')) {
			$this->data['ups_mx_08'] = $this->request->getPostE('ups_mx_08');
		} else {
			$this->data['ups_mx_08'] = $this->config->get('ups_mx_08');
		}
		
		if ($this->request->hasPost('ups_mx_54')) {
			$this->data['ups_mx_54'] = $this->request->getPostE('ups_mx_54');
		} else {
			$this->data['ups_mx_54'] = $this->config->get('ups_mx_54');
		}
		
		if ($this->request->hasPost('ups_mx_65')) {
			$this->data['ups_mx_65'] = $this->request->getPostE('ups_mx_65');
		} else {
			$this->data['ups_mx_65'] = $this->config->get('ups_mx_65');
		}

		// EU
		if ($this->request->hasPost('ups_eu_07')) {
			$this->data['ups_eu_07'] = $this->request->getPostE('ups_eu_07');
		} else {
			$this->data['ups_eu_07'] = $this->config->get('ups_eu_07');
		}
		
		if ($this->request->hasPost('ups_eu_08')) {
			$this->data['ups_eu_08'] = $this->request->getPostE('ups_eu_08');
		} else {
			$this->data['ups_eu_08'] = $this->config->get('ups_eu_08');
		}
		
		if ($this->request->hasPost('ups_eu_11')) {
			$this->data['ups_eu_11'] = $this->request->getPostE('ups_eu_11');
		} else {
			$this->data['ups_eu_11'] = $this->config->get('ups_eu_11');
		}

		if ($this->request->hasPost('ups_eu_54')) {
			$this->data['ups_eu_54'] = $this->request->getPostE('ups_eu_54');
		} else {
			$this->data['ups_eu_54'] = $this->config->get('ups_eu_54');
		}
		
		if ($this->request->hasPost('ups_eu_65')) {
			$this->data['ups_eu_65'] = $this->request->getPostE('ups_eu_65');
		} else {
			$this->data['ups_eu_65'] = $this->config->get('ups_eu_65');
		}
		
		if ($this->request->hasPost('ups_eu_82')) {
			$this->data['ups_eu_82'] = $this->request->getPostE('ups_eu_82');
		} else {
			$this->data['ups_eu_82'] = $this->config->get('ups_eu_82');
		}
	
		if ($this->request->hasPost('ups_eu_83')) {
			$this->data['ups_eu_83'] = $this->request->getPostE('ups_eu_83');
		} else {
			$this->data['ups_eu_83'] = $this->config->get('ups_eu_83');
		}
		
		if ($this->request->hasPost('ups_eu_84')) {
			$this->data['ups_eu_84'] = $this->request->getPostE('ups_eu_84');
		} else {
			$this->data['ups_eu_84'] = $this->config->get('ups_eu_84');
		}
		
		if ($this->request->hasPost('ups_eu_85')) {
			$this->data['ups_eu_85'] = $this->request->getPostE('ups_eu_85');
		} else {
			$this->data['ups_eu_85'] = $this->config->get('ups_eu_85');
		}
		
		if ($this->request->hasPost('ups_eu_86')) {
			$this->data['ups_eu_86'] = $this->request->getPostE('ups_eu_86');
		} else {
			$this->data['ups_eu_86'] = $this->config->get('ups_eu_86');
		}

		// Other
		if ($this->request->hasPost('ups_other_07')) {
			$this->data['ups_other_07'] = $this->request->getPostE('ups_other_07');
		} else {
			$this->data['ups_other_07'] = $this->config->get('ups_other_07');
		}
		
		if ($this->request->hasPost('ups_other_08')) {
			$this->data['ups_other_08'] = $this->request->getPostE('ups_other_08');
		} else {
			$this->data['ups_other_08'] = $this->config->get('ups_other_08');
		}
		
		if ($this->request->hasPost('ups_other_11')) {
			$this->data['ups_other_11'] = $this->request->getPostE('ups_other_11');
		} else {
			$this->data['ups_other_11'] = $this->config->get('ups_other_11');
		}

		if ($this->request->hasPost('ups_other_54')) {
			$this->data['ups_other_54'] = $this->request->getPostE('ups_other_54');
		} else {
			$this->data['ups_other_54'] = $this->config->get('ups_other_54');
		}

		if ($this->request->hasPost('ups_other_65')) {
			$this->data['ups_other_65'] = $this->request->getPostE('ups_other_65');
		} else {
			$this->data['ups_other_65'] = $this->config->get('ups_other_65');
		}

		if ($this->request->hasPost('ups_display_weight')) {
			$this->data['ups_display_weight'] = $this->request->getPostE('ups_display_weight');
		} else {
			$this->data['ups_display_weight'] = $this->config->get('ups_display_weight');
		}	
		
		if ($this->request->hasPost('ups_insurance')) {
			$this->data['ups_insurance'] = $this->request->getPostE('ups_insurance');
		} else {
			$this->data['ups_insurance'] = $this->config->get('ups_insurance');
		}	
		
		if ($this->request->hasPost('ups_weight_class_id')) {
			$this->data['ups_weight_class_id'] = $this->request->getPostE('ups_weight_class_id');
		} else {
		...
		if ($this->request->hasPost('ups_length_code')) {
			$this->data['ups_length_code'] = $this->request->getPostE('ups_length_code');
		} else {
			$this->data['ups_length_code'] = $this->config->get('ups_length_code');
		}
		
		if ($this->request->hasPost('ups_length_class_id')) {
			$this->data['ups_length_class_id'] = $this->request->getPostE('ups_length_class_id');
		} else {
		...
		if ($this->request->hasPost('ups_length')) {
			$this->data['ups_length'] = $this->request->getPostE('ups_length');
		} else {
			$this->data['ups_length'] = $this->config->get('ups_length');
		}
		
		if ($this->request->hasPost('ups_width')) {
			$this->data['ups_width'] = $this->request->getPostE('ups_width');
		} else {
			$this->data['ups_width'] = $this->config->get('ups_width');
		}		
		
		if ($this->request->hasPost('ups_height')) {
			$this->data['ups_height'] = $this->request->getPostE('ups_height');
		} else {
			$this->data['ups_height'] = $this->config->get('ups_height');
		}
								
		if ($this->request->hasPost('ups_tax_class_id')) {
			$this->data['ups_tax_class_id'] = $this->request->getPostE('ups_tax_class_id');
		} else {
		...
		if ($this->request->hasPost('ups_geo_zone_id')) {
			$this->data['ups_geo_zone_id'] = $this->request->getPostE('ups_geo_zone_id');
		} else {
		...
		if ($this->request->hasPost('ups_status')) {
			$this->data['ups_status'] = $this->request->getPostE('ups_status');
		} else {
			$this->data['ups_status'] = $this->config->get('ups_status');
		}

		if ($this->request->hasPost('ups_sort_order')) {
			$this->data['ups_sort_order'] = $this->request->getPostE('ups_sort_order');
		} else {
			$this->data['ups_sort_order'] = $this->config->get('ups_sort_order');
		}
		
		if ($this->request->hasPost('ups_debug')) {
			$this->data['ups_debug'] = $this->request->getPostE('ups_debug');
		} else {
			$this->data['ups_debug'] = $this->config->get('ups_debug');
		}
		
		$this->view->pick('shipping/ups');
		$this->_commonAction();
	...
	protected function validate() {
		...
		if (!$this->request->getPostE('ups_key')) {
			$this->error['key'] = $this->language->get('error_key');
		}
		
		if (!$this->request->getPostE('ups_username')) {
			$this->error['username'] = $this->language->get('error_username');
		}

		if (!$this->request->getPostE('ups_password')) {
			$this->error['password'] = $this->language->get('error_password');
		}

		if (!$this->request->getPostE('ups_city')) {
			$this->error['city'] = $this->language->get('error_city');
		}

		if (!$this->request->getPostE('ups_state')) {
			$this->error['state'] = $this->language->get('error_state');
		}

		if (!$this->request->getPostE('ups_country')) {
			$this->error['country'] = $this->language->get('error_country');
		}
		
		if ((!$this->request->getPostE('ups_length'))) {
			$this->error['dimension'] = $this->language->get('error_dimension');
		}
		
		if ((!$this->request->getPostE('ups_width'))) {
			$this->error['dimension'] = $this->language->get('error_dimension');
		}
		
		if ((!$this->request->getPostE('ups_height'))) {
			$this->error['dimension'] = $this->language->get('error_dimension');
		}
