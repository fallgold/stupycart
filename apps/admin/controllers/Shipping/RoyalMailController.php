...
class RoyalMailController extends \Stupycart\Admin\Controllers\ControllerBase {
	private $error = array(); 
	...
	public function indexAction() {   
		...
		if (($this->request->getServer('REQUEST_METHOD') == 'POST') && $this->validate()) {
			$this->model_setting_setting->editSetting('royal_mail', $this->request->getPostE());		
		...
		if (isset($this->error['warning']))  {
  		...
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('shipping/royal_mail', 'token=' . $this->session->get('token'), 'SSL'),
      		'separator' => ' :: '
   		);
		
		$this->data['action'] = $this->url->link('shipping/royal_mail', 'token=' . $this->session->get('token'), 'SSL');
		
		$this->data['cancel'] = $this->url->link('extension/shipping', 'token=' . $this->session->get('token'), 'SSL');

		// 1st Class Standard
		if ($this->request->hasPost('royal_mail_1st_class_standard_rate')) {
			$this->data['royal_mail_1st_class_standard_rate'] = $this->request->getPostE('royal_mail_1st_class_standard_rate');
		...
		if ($this->request->hasPost('royal_mail_1st_class_standard_insurance')) {
			$this->data['royal_mail_1st_class_standard_insurance'] = $this->request->getPostE('royal_mail_1st_class_standard_insurance');
		...
		if ($this->request->hasPost('royal_mail_1st_class_standard_status')) {
			$this->data['royal_mail_1st_class_standard_status'] = $this->request->getPostE('royal_mail_1st_class_standard_status');
		} else {
			$this->data['royal_mail_1st_class_standard_status'] = $this->config->get('royal_mail_1st_class_standard_status');
		}
				
		// 1st Class Recorded		
		if ($this->request->hasPost('royal_mail_1st_class_recorded_rate')) {
			$this->data['royal_mail_1st_class_recorded_rate'] = $this->request->getPostE('royal_mail_1st_class_recorded_rate');
		...
		if ($this->request->hasPost('royal_mail_1st_class_recorded_insurance')) {
			$this->data['royal_mail_1st_class_recorded_insurance'] = $this->request->getPostE('royal_mail_1st_class_recorded_insurance');
		...
		if ($this->request->hasPost('royal_mail_1st_class_recorded_status')) {
			$this->data['royal_mail_1st_class_recorded_status'] = $this->request->getPostE('royal_mail_1st_class_recorded_status');
		} else {
			$this->data['royal_mail_1st_class_recorded_status'] = $this->config->get('royal_mail_1st_class_recorded_status');
		}
						
		// 2nd Class Standard	
		if ($this->request->hasPost('royal_mail_2nd_class_standard_rate')) {
			$this->data['royal_mail_2nd_class_standard_rate'] = $this->request->getPostE('royal_mail_2nd_class_standard_rate');
		...
		if ($this->request->hasPost('royal_mail_2nd_class_standard_status')) {
			$this->data['royal_mail_2nd_class_standard_status'] = $this->request->getPostE('royal_mail_2nd_class_standard_status');
		} else {
			$this->data['royal_mail_2nd_class_standard_status'] = $this->config->get('royal_mail_2nd_class_standard_status');
		}
				
		// 2nd Class Recorded
		if ($this->request->hasPost('royal_mail_2nd_class_recorded_rate')) {
			$this->data['royal_mail_2nd_class_recorded_rate'] = $this->request->getPostE('royal_mail_2nd_class_recorded_rate');
		...
		if ($this->request->hasPost('royal_mail_2nd_class_recorded_insurance')) {
			$this->data['royal_mail_2nd_class_recorded_insurance'] = $this->request->getPostE('royal_mail_2nd_class_recorded_insurance');
		...
		if ($this->request->hasPost('royal_mail_2nd_class_recorded_status')) {
			$this->data['royal_mail_2nd_class_recorded_status'] = $this->request->getPostE('royal_mail_2nd_class_recorded_status');
		} else {
			$this->data['royal_mail_2nd_class_recorded_status'] = $this->config->get('royal_mail_2nd_class_recorded_status');
		}
						
		// Special Delivery < 500
		if ($this->request->hasPost('royal_mail_special_delivery_500_rate')) {
			$this->data['royal_mail_special_delivery_500_rate'] = $this->request->getPostE('royal_mail_special_delivery_500_rate');
		...
		if ($this->request->hasPost('royal_mail_special_delivery_500_insurance')) {
			$this->data['royal_mail_special_delivery_500_insurance'] = $this->request->getPostE('royal_mail_special_delivery_500_insurance');
		...
		if ($this->request->hasPost('royal_mail_special_delivery_500_status')) {
			$this->data['royal_mail_special_delivery_500_status'] = $this->request->getPostE('royal_mail_special_delivery_500_status');
		} else {
		...
		if ($this->request->hasPost('royal_mail_special_delivery_1000_rate')) {
			$this->data['royal_mail_special_delivery_1000_rate'] = $this->request->getPostE('royal_mail_special_delivery_1000_rate');
		...
		if ($this->request->hasPost('royal_mail_special_delivery_1000_insurance')) {
			$this->data['royal_mail_special_delivery_1000_insurance'] = $this->request->getPostE('royal_mail_special_delivery_1000_insurance');
		...
		if ($this->request->hasPost('royal_mail_special_delivery_1000_status')) {
			$this->data['royal_mail_special_delivery_1000_status'] = $this->request->getPostE('royal_mail_special_delivery_1000_status');
		} else {
		...
		if ($this->request->hasPost('royal_mail_special_delivery_2500_rate')) {
			$this->data['royal_mail_special_delivery_2500_rate'] = $this->request->getPostE('royal_mail_special_delivery_2500_rate');
		...
		if ($this->request->hasPost('royal_mail_special_delivery_2500_insurance')) {
			$this->data['royal_mail_special_delivery_2500_insurance'] = $this->request->getPostE('royal_mail_special_delivery_2500_insurance');
		...
		if ($this->request->hasPost('royal_mail_special_delivery_2500_status')) {
			$this->data['royal_mail_special_delivery_2500_status'] = $this->request->getPostE('royal_mail_special_delivery_2500_status');
		} else {
			$this->data['royal_mail_special_delivery_2500_status'] = $this->config->get('royal_mail_special_delivery_2500_status');
		}
						
		// Standard Parcels
		if ($this->request->hasPost('royal_mail_standard_parcels_rate')) {
			$this->data['royal_mail_standard_parcels_rate'] = $this->request->getPostE('royal_mail_standard_parcels_rate');
		...
		if ($this->request->hasPost('royal_mail_standard_parcels_insurance')) {
			$this->data['royal_mail_standard_parcels_insurance'] = $this->request->getPostE('royal_mail_standard_parcels_insurance');
		...
		if ($this->request->hasPost('royal_mail_standard_parcels_status')) {
			$this->data['royal_mail_standard_parcels_status'] = $this->request->getPostE('royal_mail_standard_parcels_status');
		} else {
			$this->data['royal_mail_standard_parcels_status'] = $this->config->get('royal_mail_standard_parcels_status');
		}
						
		// Airmail
		if ($this->request->hasPost('royal_mail_airmail_rate_1')) {
			$this->data['royal_mail_airmail_rate_1'] = $this->request->getPostE('royal_mail_airmail_rate_1');
		...
		if ($this->request->hasPost('royal_mail_airmail_rate_2')) {
			$this->data['royal_mail_airmail_rate_2'] = $this->request->getPostE('royal_mail_airmail_rate_2');
		...
		if ($this->request->hasPost('royal_mail_airmail_status')) {
			$this->data['royal_mail_airmail_status'] = $this->request->getPostE('royal_mail_airmail_status');
		} else {
			$this->data['royal_mail_airmail_status'] = $this->config->get('royal_mail_airmail_status');
		}
						
		// International Signed
		if ($this->request->hasPost('royal_mail_international_signed_rate_1')) {
			$this->data['royal_mail_international_signed_rate_1'] = $this->request->getPostE('royal_mail_international_signed_rate_1');
		...
		if ($this->request->hasPost('royal_mail_international_signed_insurance_1')) {
			$this->data['royal_mail_international_signed_insurance_1'] = $this->request->getPostE('royal_mail_international_signed_insurance_1');
		...
		if ($this->request->hasPost('royal_mail_international_signed_rate_2')) {
			$this->data['royal_mail_international_signed_rate_2'] = $this->request->getPostE('royal_mail_international_signed_rate_2');
		...
		if ($this->request->hasPost('royal_mail_international_signed_insurance_2')) {
			$this->data['royal_mail_international_signed_insurance_2'] = $this->request->getPostE('royal_mail_international_signed_insurance_2');
		...
		if ($this->request->hasPost('royal_mail_international_signed_status')) {
			$this->data['royal_mail_international_signed_status'] = $this->request->getPostE('royal_mail_international_signed_status');
		} else {
			$this->data['royal_mail_international_signed_status'] = $this->config->get('royal_mail_international_signed_status');
		}
								
		// Airsure
		if ($this->request->hasPost('royal_mail_airsure_rate_1')) {
			$this->data['royal_mail_airsure_rate_1'] = $this->request->getPostE('royal_mail_airsure_rate_1');
		...
		if ($this->request->hasPost('royal_mail_airsure_insurance_1')) {
			$this->data['royal_mail_airsure_insurance_1'] = $this->request->getPostE('royal_mail_airsure_insurance_1');
		...
		if ($this->request->hasPost('royal_mail_airsure_rate_2')) {
			$this->data['royal_mail_airsure_rate_2'] = $this->request->getPostE('royal_mail_airsure_rate_2');
		...
		if ($this->request->hasPost('royal_mail_airsure_insurance_2')) {
			$this->data['royal_mail_airsure_insurance_2'] = $this->request->getPostE('royal_mail_airsure_insurance_2');
		...
		if ($this->request->hasPost('royal_mail_airsure_status')) {
			$this->data['royal_mail_airsure_status'] = $this->request->getPostE('royal_mail_airsure_status');
		} else {
			$this->data['royal_mail_airsure_status'] = $this->config->get('royal_mail_airsure_status');
		}
							
		// Surface
		if ($this->request->hasPost('royal_mail_surface_rate')) {
			$this->data['royal_mail_surface_rate'] = $this->request->getPostE('royal_mail_surface_rate');
		...
		if ($this->request->hasPost('royal_mail_surface_status')) {
			$this->data['royal_mail_surface_status'] = $this->request->getPostE('royal_mail_surface_status');
		} else {
			$this->data['royal_mail_surface_status'] = $this->config->get('royal_mail_surface_status');
		}
				
		if ($this->request->hasPost('royal_mail_display_weight')) {
			$this->data['royal_mail_display_weight'] = $this->request->getPostE('royal_mail_display_weight');
		} else {
			$this->data['royal_mail_display_weight'] = $this->config->get('royal_mail_display_weight');
		}
		
		if ($this->request->hasPost('royal_mail_display_insurance')) {
			$this->data['royal_mail_display_insurance'] = $this->request->getPostE('royal_mail_display_insurance');
		} else {
			$this->data['royal_mail_display_insurance'] = $this->config->get('royal_mail_display_insurance');
		}

		if ($this->request->hasPost('royal_mail_weight_class_id')) {
			$this->data['royal_mail_weight_class_id'] = $this->request->getPostE('royal_mail_weight_class_id');
		} else {
		...
		if ($this->request->hasPost('royal_mail_tax_class_id')) {
			$this->data['royal_mail_tax_class_id'] = $this->request->getPostE('royal_mail_tax_class_id');
		} else {
		...
		if ($this->request->hasPost('royal_mail_geo_zone_id')) {
			$this->data['royal_mail_geo_zone_id'] = $this->request->getPostE('royal_mail_geo_zone_id');
		} else {
		...
		if ($this->request->hasPost('royal_mail_status')) {
			$this->data['royal_mail_status'] = $this->request->getPostE('royal_mail_status');
		} else {
			$this->data['royal_mail_status'] = $this->config->get('royal_mail_status');
		}
		
		if ($this->request->hasPost('royal_mail_sort_order')) {
			$this->data['royal_mail_sort_order'] = $this->request->getPostE('royal_mail_sort_order');
		} else {
			$this->data['royal_mail_sort_order'] = $this->config->get('royal_mail_sort_order');
		}				

		$this->view->pick('shipping/royal_mail');
		$this->_commonAction();
