        ...
        <table class="form">
          <tr>
            ...
            <td><?php foreach ($languages as $language) { ?>
              ...
              <img src="{$this->url->getBaseUrl()}image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /><br />
...
function addOptionValue() {
	...
	<?php foreach ($languages as $language) { ?>
	html += '<input type="text" name="option_value[' + option_value_row + '][option_value_description][<?php echo $language['language_id']; ?>][name]" value="" /> <img src="{$this->url->getBaseUrl()}image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /><br />';
    <?php } ?>
	html += '    </td>';
