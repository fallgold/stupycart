...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="{$this->url->getBaseUrl()}image/download.png" alt="" /> <?php echo $heading_title; ?></h1>
...
new AjaxUpload('#button-upload', {
	action: '{$this->url->getBaseUrl()}catalog/download/upload?token=<?php echo $token; ?>',
	name: 'file',
	autoSubmit: true,
	responseType: 'json',
	onSubmit: function(file, extension) {
		$('#button-upload').after('<img src="{$this->url->getBaseUrl()}image/loading.gif" class="loading" style="padding-left: 5px;" />');
