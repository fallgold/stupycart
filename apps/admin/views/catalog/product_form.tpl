...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="{$this->url->getBaseUrl()}image/product.png" alt="" /> <?php echo $heading_title; ?></h1>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          <div id="languages" class="htabs">
            ...
            <a href="#language<?php echo $language['language_id']; ?>"><img src="{$this->url->getBaseUrl()}image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a>
            <?php } ?>
          </div>
          <?php foreach ($languages as $language) { ?>
          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><div id="product-category" class="scrollbox">
                  ...
                  <div id="product-category<?php echo $product_category['category_id']; ?>" class="<?php echo $class; ?>"><?php echo $product_category['name']; ?><img src="{$this->url->getBaseUrl()}image/delete.png" alt="" />
            ...
            <tr>
              ...
              <td><div id="product-filter" class="scrollbox">
                  ...
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div id="product-filter<?php echo $product_filter['filter_id']; ?>" class="<?php echo $class; ?>"><?php echo $product_filter['name']; ?><img src="{$this->url->getBaseUrl()}image/delete.png" alt="" />
            ...
            <tr>
              ...
              <td><div id="product-download" class="scrollbox">
                  ...
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div id="product-download<?php echo $product_download['download_id']; ?>" class="<?php echo $class; ?>"> <?php echo $product_download['name']; ?><img src="{$this->url->getBaseUrl()}image/delete.png" alt="" />
            ...
            <tr>
              ...
              <td><div id="product-related" class="scrollbox">
                  ...
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div id="product-related<?php echo $product_related['product_id']; ?>" class="<?php echo $class; ?>"> <?php echo $product_related['name']; ?><img src="{$this->url->getBaseUrl()}image/delete.png" alt="" />
            ...
            <tbody id="attribute-row<?php echo $attribute_row; ?>">
              <tr>
                ...
                <td class="left"><?php foreach ($languages as $language) { ?>
                  ...
                  <img src="{$this->url->getBaseUrl()}image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" align="top" /><br />
                  <?php } ?></td>
        ...
        <div id="tab-option">
          <div id="vtab-option" class="vtabs">
            ...
            <a href="#tab-option-<?php echo $option_row; ?>" id="option-<?php echo $option_row; ?>"><?php echo $product_option['name']; ?>&nbsp;<img src="{$this->url->getBaseUrl()}image/delete.png" alt="" onclick="$('#option-<?php echo $option_row; ?>').remove(); $('#tab-option-<?php echo $option_row; ?>').remove(); $('#vtabs a:first').trigger('click'); return false;" /></a>
            <?php $option_row++; ?>
            <?php } ?>
            <span id="option-add">
            <input name="option" value="" style="width: 130px;" />
            &nbsp;<img src="{$this->url->getBaseUrl()}image/add.png" alt="<?php echo $button_add_option; ?>" title="<?php echo $button_add_option; ?>" /></span></div>
          <?php $option_row = 0; ?>
...
<script type="text/javascript" src="{$this->url->getBaseUrl()}javascript/ckeditor/ckeditor.js"></script> 
<script type="text/javascript"><!--
<?php foreach ($languages as $language) { ?>
CKEDITOR.replace('description<?php echo $language['language_id']; ?>', {
	filebrowserBrowseUrl: '{$this->url->getBaseUrl()}common/filemanager?token=<?php echo $token; ?>',
	filebrowserImageBrowseUrl: '{$this->url->getBaseUrl()}common/filemanager?token=<?php echo $token; ?>',
	filebrowserFlashBrowseUrl: '{$this->url->getBaseUrl()}common/filemanager?token=<?php echo $token; ?>',
	filebrowserUploadUrl: '{$this->url->getBaseUrl()}common/filemanager?token=<?php echo $token; ?>',
	filebrowserImageUploadUrl: '{$this->url->getBaseUrl()}common/filemanager?token=<?php echo $token; ?>',
	filebrowserFlashUploadUrl: '{$this->url->getBaseUrl()}common/filemanager?token=<?php echo $token; ?>'
});
<?php } ?>
//--></script> 
<script type="text/javascript"><!--
...
$('input[name=\'manufacturer\']').autocomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: '{$this->url->getBaseUrl()}catalog/manufacturer/autocomplete&token=<?php echo $token; ?>?filter_name=' +  encodeURIComponent(request.term),
			dataType: 'json',
...
$('input[name=\'category\']').autocomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: '{$this->url->getBaseUrl()}catalog/category/autocomplete&token=<?php echo $token; ?>?filter_name=' +  encodeURIComponent(request.term),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
	...
	select: function(event, ui) {
		...
		$('#product-category').append('<div id="product-category' + ui.item.value + '">' + ui.item.label + '<img src="{$this->url->getBaseUrl()}image/delete.png" alt="" /><input type="hidden" name="product_category[]" value="' + ui.item.value + '" /></div>');
...
$('input[name=\'filter\']').autocomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: '{$this->url->getBaseUrl()}catalog/filter/autocomplete&token=<?php echo $token; ?>?filter_name=' +  encodeURIComponent(request.term),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
	...
	select: function(event, ui) {
		...
		$('#product-filter').append('<div id="product-filter' + ui.item.value + '">' + ui.item.label + '<img src="{$this->url->getBaseUrl()}image/delete.png" alt="" /><input type="hidden" name="product_filter[]" value="' + ui.item.value + '" /></div>');
...
$('input[name=\'download\']').autocomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: '{$this->url->getBaseUrl()}catalog/download/autocomplete&token=<?php echo $token; ?>?filter_name=' +  encodeURIComponent(request.term),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
	...
	select: function(event, ui) {
		...
		$('#product-download').append('<div id="product-download' + ui.item.value + '">' + ui.item.label + '<img src="{$this->url->getBaseUrl()}image/delete.png" alt="" /><input type="hidden" name="product_download[]" value="' + ui.item.value + '" /></div>');
...
$('input[name=\'related\']').autocomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: '{$this->url->getBaseUrl()}catalog/product/autocomplete&token=<?php echo $token; ?>?filter_name=' +  encodeURIComponent(request.term),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
	...
	select: function(event, ui) {
		...
		$('#product-related').append('<div id="product-related' + ui.item.value + '">' + ui.item.label + '<img src="{$this->url->getBaseUrl()}image/delete.png" alt="" /><input type="hidden" name="product_related[]" value="' + ui.item.value + '" /></div>');
...
function addAttribute() {
	...
	html += '    <td class="left">';
	<?php foreach ($languages as $language) { ?>
	html += '<textarea name="product_attribute[' + attribute_row + '][product_attribute_description][<?php echo $language['language_id']; ?>][text]" cols="40" rows="5"></textarea><img src="{$this->url->getBaseUrl()}image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" align="top" /><br />';
    <?php } ?>
	html += '    </td>';
...
function attributeautocomplete(attribute_row) {
	$('input[name=\'product_attribute[' + attribute_row + '][name]\']').catcomplete({
		...
		source: function(request, response) {
			$.ajax({
				url: '{$this->url->getBaseUrl()}catalog/attribute/autocomplete&token=<?php echo $token; ?>?filter_name=' +  encodeURIComponent(request.term),
				dataType: 'json',
				success: function(json) {	
					response($.map(json, function(item) {
						return {
...
$('input[name=\'option\']').catcomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: '{$this->url->getBaseUrl()}catalog/option/autocomplete&token=<?php echo $token; ?>?filter_name=' +  encodeURIComponent(request.term),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
	...
	select: function(event, ui) {
		...
		$('#option-add').before('<a href="#tab-option-' + option_row + '" id="option-' + option_row + '">' + ui.item.label + '&nbsp;<img src="{$this->url->getBaseUrl()}image/delete.png" alt="" onclick="$(\'#option-' + option_row + '\').remove(); $(\'#tab-option-' + option_row + '\').remove(); $(\'#vtab-option a:first\').trigger(\'click\'); return false;" /></a>');
...
function image_upload(field, thumb) {
	...
	$('#content').prepend('<div id="dialog" style="padding: 3px 0px 0px 0px;"><iframe src="{$this->url->getBaseUrl()}common/filemanager&token=<?php echo $token; ?>?field=' + encodeURIComponent(field) + '" style="padding:0; margin: 0; display: block; width: 100%; height: 100%;" frameborder="no" scrolling="auto"></iframe></div>');
	...
	$('#dialog').dialog({
		...
		close: function (event, ui) {
			if ($('#' + field).attr('value')) {
				$.ajax({
					url: '{$this->url->getBaseUrl()}common/filemanager/image&token=<?php echo $token; ?>?image=' + encodeURIComponent($('#' + field).attr('value')),
					dataType: 'text',
...
//--></script> 
<script type="text/javascript" src="{$this->url->getBaseUrl()}javascript/jquery/ui/jquery-ui-timepicker-addon.js"></script> 
<script type="text/javascript"><!--
$('.date').datepicker({ dateFormat: 'yy-mm-dd'});
$('.datetime').datetimepicker({
	dateFormat: 'yy-mm-dd',
