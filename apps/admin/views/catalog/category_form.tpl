...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="{$this->url->getBaseUrl()}image/category.png" alt="" /> <?php echo $heading_title; ?></h1>
          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><div id="category-filter" class="scrollbox">
                  ...
                  <div id="category-filter<?php echo $category_filter['filter_id']; ?>" class="<?php echo $class; ?>"><?php echo $category_filter['name']; ?><img src="{$this->url->getBaseUrl()}image/delete.png" alt="" />
...
$('input[name=\'filter\']').autocomplete({
	...
	select: function(event, ui) {
		...
		$('#category-filter').append('<div id="category-filter' + ui.item.value + '">' + ui.item.label + '<img src="{$this->url->getBaseUrl()}image/delete.png" alt="" /><input type="hidden" name="category_filter[]" value="' + ui.item.value + '" /></div>');
...
function image_upload(field, thumb) {
	...
	$('#dialog').dialog({
		...
		close: function (event, ui) {
			if ($('#' + field).attr('value')) {
				$.ajax({
					url: '{$this->url->getBaseUrl()}common/filemanager/image&token=<?php echo $token; ?>?image=' + encodeURIComponent($('#' + field).val()),
					dataType: 'text',
