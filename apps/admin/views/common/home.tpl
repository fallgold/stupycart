...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="{$this->url->getBaseUrl()}image/home.png" alt="" /> <?php echo $heading_title; ?></h1>
    </div>
    <div class="content">
      <div class="overview">
...
<!--[if IE]>
<script type="text/javascript" src="{$this->url->getBaseUrl()}javascript/jquery/flot/excanvas.js"></script>
<![endif]--> 
<script type="text/javascript" src="{$this->url->getBaseUrl()}javascript/jquery/flot/jquery.flot.js"></script> 
<script type="text/javascript"><!--
function getSalesChart(range) {
	$.ajax({
		type: 'get',
		url: '{$this->url->getBaseUrl()}common/home/chart&token=<?php echo $token; ?>?range=' + range,
		dataType: 'json',
		async: false,
