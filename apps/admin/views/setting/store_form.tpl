        ...
        <div id="tab-store">
          <table class="form">
            ...
            <tr>
              ...
              <td><select name="config_template" onchange="$('#template').load('{$this->url->getBaseUrl()}setting/store/template&token=<?php echo $token; ?>?template=' + encodeURIComponent(this.value));">
...
$('#template').load('{$this->url->getBaseUrl()}setting/store/template&token=<?php echo $token; ?>?template=' + encodeURIComponent($('select[name=\'config_template\']').attr('value')));
//--></script>
<script type="text/javascript"><!--
$('select[name=\'config_country_id\']').bind('change', function() {
	$.ajax({
		url: '{$this->url->getBaseUrl()}setting/store/country&token=<?php echo $token; ?>?country_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
