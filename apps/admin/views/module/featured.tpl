        ...
        <table class="form">
          ...
          <tr>
            ...
            <td><div id="featured-product" class="scrollbox">
                ...
                <div id="featured-product<?php echo $product['product_id']; ?>" class="<?php echo $class; ?>"><?php echo $product['name']; ?> <img src="{$this->url->getBaseUrl()}image/delete.png" alt="" />
...
$('input[name=\'product\']').autocomplete({
	...
	select: function(event, ui) {
		...
		$('#featured-product').append('<div id="featured-product' + ui.item.value + '">' + ui.item.label + '<img src="{$this->url->getBaseUrl()}image/delete.png" alt="" /><input type="hidden" value="' + ui.item.value + '" /></div>');
