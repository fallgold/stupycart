...
$('select[name=\'country_id\']').bind('change', function() {
	$.ajax({
		url: '{$this->url->getBaseUrl()}sale/affiliate/country&token=<?php echo $token; ?>?country_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
...
$('#transaction').load('{$this->url->getBaseUrl()}sale/affiliate/transaction&token=<?php echo $token; ?>?affiliate_id=<?php echo $affiliate_id; ?>');

function addTransaction() {
	$.ajax({
		url: '{$this->url->getBaseUrl()}sale/affiliate/transaction&token=<?php echo $token; ?>?affiliate_id=<?php echo $affiliate_id; ?>',
		type: 'post',
		dataType: 'html',
