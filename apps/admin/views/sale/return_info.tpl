...
$('select[name=\'return_action_id\']').bind('change', function() {
	$.ajax({
		url: '{$this->url->getBaseUrl()}sale/return/action&token=<?php echo $token; ?>?return_id=<?php echo $return_id; ?>',
		type: 'post',
		dataType: 'json',
...
$('#history').load('{$this->url->getBaseUrl()}sale/return/history&token=<?php echo $token; ?>?return_id=<?php echo $return_id; ?>');

function history() {
	$.ajax({
		url: '{$this->url->getBaseUrl()}sale/return/history&token=<?php echo $token; ?>?return_id=<?php echo $return_id; ?>',
		type: 'post',
		dataType: 'html',
