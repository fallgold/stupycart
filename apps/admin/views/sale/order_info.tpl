...
$('#invoice-generate').live('click', function() {
	$.ajax({
		url: '{$this->url->getBaseUrl()}sale/order/createinvoiceno&token=<?php echo $token; ?>?order_id=<?php echo $order_id; ?>',
		dataType: 'json',
		beforeSend: function() {
			$('#invoice').after('<img src="{$this->url->getBaseUrl()}image/loading.gif" class="loading" style="padding-left: 5px;" />');	
		},
		complete: function() {
			$('.loading').remove();
		},
...
$('#credit-add').live('click', function() {
	$.ajax({
		url: '{$this->url->getBaseUrl()}sale/order/addcredit&token=<?php echo $token; ?>?order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
			$('#credit').after('<img src="{$this->url->getBaseUrl()}image/loading.gif" class="loading" style="padding-left: 5px;" />');			
		},
		complete: function() {
			$('.loading').remove();
		},			
...
$('#credit-remove').live('click', function() {
	$.ajax({
		url: '{$this->url->getBaseUrl()}sale/order/removecredit&token=<?php echo $token; ?>?order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
			$('#credit').after('<img src="{$this->url->getBaseUrl()}image/loading.gif" class="loading" style="padding-left: 5px;" />');			
...
$('#reward-add').live('click', function() {
	$.ajax({
		url: '{$this->url->getBaseUrl()}sale/order/addreward&token=<?php echo $token; ?>?order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
			$('#reward').after('<img src="{$this->url->getBaseUrl()}image/loading.gif" class="loading" style="padding-left: 5px;" />');			
		},
		complete: function() {
			$('.loading').remove();
		},									
...
$('#reward-remove').live('click', function() {
	$.ajax({
		url: '{$this->url->getBaseUrl()}sale/order/removereward&token=<?php echo $token; ?>?order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
			$('#reward').after('<img src="{$this->url->getBaseUrl()}image/loading.gif" class="loading" style="padding-left: 5px;" />');
...
$('#commission-add').live('click', function() {
	$.ajax({
		url: '{$this->url->getBaseUrl()}sale/order/addcommission&token=<?php echo $token; ?>?order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
			$('#commission').after('<img src="{$this->url->getBaseUrl()}image/loading.gif" class="loading" style="padding-left: 5px;" />');			
		},
		complete: function() {
			$('.loading').remove();
		},			
...
$('#commission-remove').live('click', function() {
	$.ajax({
		url: '{$this->url->getBaseUrl()}sale/order/removecommission&token=<?php echo $token; ?>?order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
			$('#commission').after('<img src="{$this->url->getBaseUrl()}image/loading.gif" class="loading" style="padding-left: 5px;" />');			
...
$('#history').load('{$this->url->getBaseUrl()}sale/order/history&token=<?php echo $token; ?>?order_id=<?php echo $order_id; ?>');

$('#button-history').live('click', function() {
	$.ajax({
		url: '{$this->url->getBaseUrl()}sale/order/history&token=<?php echo $token; ?>?order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'html',
		...
		beforeSend: function() {
			...
			$('#history').prepend('<div class="attention"><img src="{$this->url->getBaseUrl()}image/loading.gif" alt="" /> <?php echo $text_wait; ?></div>');
		},
		complete: function() {
