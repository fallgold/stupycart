        ...
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="left"><select onchange="((this.value !== '') ? window.open('{$this->url->getBaseUrl()}sale/customer/login&token=<?php echo $token; ?>&customer_id=<?php echo $customer['customer_id']; ?>?store_id=' + this.value) : null); this.value = '';">
...
function filter() {
	url = '{$this->url->getBaseUrl()}sale/customer?token=<?php echo $token; ?>';
