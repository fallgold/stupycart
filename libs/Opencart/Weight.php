...
class Weight extends \Phalcon\DI\Injectable {
	...
	public function __construct($registry) {
		...
		$weight_class_query = $this->ocdb->db_query("SELECT * FROM " . DB_PREFIX . "weight_class wc LEFT JOIN " . DB_PREFIX . "weight_class_description wcd ON (wc.weight_class_id = wcd.weight_class_id) WHERE wcd.language_id = '" . (int)$this->config->get('config_language_id') . "'");
