...
<div id="main" role="main">
	...
	<?php }?>
	<form action="index.php?route=product/search_mobile" method="post" class="inline-form module">
		<fieldset >
			<?php
			...
			<?php } elseif ($search) { ?>
			<input type="search" name="<?php echo $field_name; ?>"  placeholder="<?php echo $search; ?>" />
			<?php } else { ?>
			<input type="search" name="<?php echo $field_name; ?>"  placeholder="<?php echo $text_critea; ?>" />
			<?php }?>
